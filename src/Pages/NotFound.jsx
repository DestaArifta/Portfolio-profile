    ...
    return (
        <main className="h-screen flex items-center px-6 lg:px-32">
            <section className="animate-fade-in-down w-full md:w-9/12 xl:w-8/12">
                <h1 className="text-7xl my-5 lg:text-15xl font-bold text-green-500">
                404
                </h1>
                ...
                <div className="hidden my-8 w-full md:block md:w-auto" id="navbar-default">
                    <ul className="flex flex-col py-4 mt-5 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0">
                        <li>
                            <Link to="/" className="block lg:text-xl py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-white md:p-0 dark:text-white" aria-current="page">
                                Home
                            </Link>
                        </li>
                        <li>
