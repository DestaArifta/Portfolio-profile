    ...
    return (
        <div>
            ...
            <div className="animate-fade-in-down container mx-auto bg-black opacity-90 p-4 mt-12">
                <h5 className='text-sm text-bold text-white'>Contact</h5>
                <hr className="w-48 h-1 bg-gray-100 border-0 rounded md:my-2 dark:bg-yellow-700"></hr>
                <h1 className='text-4xl text-white text-bold'>CONTACT ME</h1>
                ...
                <div className="grid grid-cols-2 gap-2 my-8">
                    ...
                    <div className=" p-6 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <a href="#">
                            <h5 className="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Alamat</h5>
                        </a>
                        <p className="mb-3 font-normal text-gray-500 dark:text-gray-400">Jalan H. Mursali No.99H, Munggang<br></br>Jakarta Utara</p>
                    </div>

                    <div className=" p-6 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                        <svg className="w-10 h-10 mb-2 text-gray-500 dark:text-gray-400" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5 5a3 3 0 015-2.236A3 3 0 0114.83 6H16a2 2 0 110 4h-5V9a1 1 0 10-2 0v1H4a2 2 0 110-4h1.17C5.06 5.687 5 5.35 5 5zm4 1V5a1 1 0 10-1 1h1zm3 0a1 1 0 10-1-1v1h1z" clip-rule="evenodd"></path><path d="M9 11H3v5a2 2 0 002 2h4v-7zM11 18h4a2 2 0 002-2v-5h-6v7z"></path></svg>
                        <a href="#">
                            <h5 className="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Social Profiles</h5>
                        </a>
                    ...
                    <div className=" p-6 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                        <svg className="w-10 h-10 mb-2 text-gray-500 dark:text-gray-400" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5 5a3 3 0 015-2.236A3 3 0 0114.83 6H16a2 2 0 110 4h-5V9a1 1 0 10-2 0v1H4a2 2 0 110-4h1.17C5.06 5.687 5 5.35 5 5zm4 1V5a1 1 0 10-1 1h1zm3 0a1 1 0 10-1-1v1h1z" clip-rule="evenodd"></path><path d="M9 11H3v5a2 2 0 002 2h4v-7zM11 18h4a2 2 0 002-2v-5h-6v7z"></path></svg>
                        <a href="#">
                            <h5 className="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Email Me</h5>
                        </a>
                        <p className="mb-3 font-normal text-gray-500 dark:text-gray-400">desta.arifta@gmail.com</p>
                    </div>

                    <div className=" p-6 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                        <svg className="w-10 h-10 mb-2 text-gray-500 dark:text-gray-400" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5 5a3 3 0 015-2.236A3 3 0 0114.83 6H16a2 2 0 110 4h-5V9a1 1 0 10-2 0v1H4a2 2 0 110-4h1.17C5.06 5.687 5 5.35 5 5zm4 1V5a1 1 0 10-1 1h1zm3 0a1 1 0 10-1-1v1h1z" clip-rule="evenodd"></path><path d="M9 11H3v5a2 2 0 002 2h4v-7zM11 18h4a2 2 0 002-2v-5h-6v7z"></path></svg>
                        <a href="#">
                            <h5 className="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Call Me</h5>
                        </a>
                        <p className="mb-3 font-normal text-gray-500 dark:text-gray-400">+62 8577 5312 667</p>
                    </div>
                </div>

                <div className="grid grid-cols-1 gap-2 my-8">
                <iframe className='w-full h-96' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1871.6644453184228!2d106.85342286246048!3d-6.27440220462547!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x5f7752fddc82c894!2zNsKwMTYnMjYuMSJTIDEwNsKwNTEnMDcuNCJF!5e0!3m2!1sen!2sid!4v1674054991266!5m2!1sen!2sid"></iframe>
                </div>
            </div>
        </div>
